...
int main() {
  ...
  // Initialize C++ syntax highlighting
  ImGuiCodeEditor::Initialize();
  ImGuiCodeEditor::LoadLanguages(io.IniFilename);
  ...
  while (true) {
    ...
    // Add a code editor
    static ImGuiCodeEditor codeEditor;
    codeEditor.Render("Code Editor", io.DisplaySize.x, io.DisplaySize.y);
  ...
  // Clean up dear imgui and C++ syntax highlighting
  ImGui_ImplOpenGL3_Shutdown();
  ImGui_ImplGlfw_Shutdown();
  ImGui::DestroyContext();
  ImGuiCodeEditor::Shutdown();
